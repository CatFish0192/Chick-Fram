...
╰─────────────────────────╯
    ...
    if not o.path.exists("XJZY.db"):
        #新年快乐！
        debug = input("小白：不知不觉间，小鸡庄园已经过走过了两年。")
        input("小白：这两年我们从连数据存储都没有的V1版本到了丰富的V2版本。")
        input("小白：所以真的很感谢为小鸡庄园贡献过的各位。")
        input("小白：最后，祝大家在新的一年里开开心心！")
        if debug == "db": #调试模式
            prco(debugmenu, 2)
            ...
            clear()
            if neco == False:
                prco("获得成就[" + Fore.LIGHTRED_EX + "新年快乐!" + Fore.RESET + "]")
                neco = True
            t.sleep(1)
        if savedate:
            json_Gold = 5
        ...
        if xjzydbresult != None: #数据库为空
            ...
            if json_Gold != Gold or json_Stealth_potions != Stealth_potions or json_How_much_feed_the_chicks_ate_in_total != How_much_feed_the_chicks_ate_in_total or json_Accelerator_card != Accelerator_card or json_How_much_corn_is_there_in_total != How_much_corn_is_there_in_total or json_How_many_corn_seeds_there_were != How_many_corn_seeds_there_were:
                ...
                t.sleep(1)
                if mmod == False:
                    prco("获得成就[" + Fore.LIGHTGREEN_EX + "新年小偷！" + Fore.RESET + "]")
                    mmod = True
                    t.sleep(1)
        else:
            Gold = 5
    ...
    while True:
        if figo == False and Gold > 5:
            prco("获得成就[" + Fore.LIGHTRED_EX + "祝你财源滚滚" + Fore.RESET + "]")
            figo = True
            t.sleep(1)
        ...
        if What_to_do == "恭喜发财":
            if pope == False:
                prco("没有红包哦")
                t.sleep(0.5)
                prco("获得成就[" + Fore.LIGHTGREEN_EX + "没有红包哦" + Fore.RESET + "]")
                pope = True
                t.sleep(0.5)
            else:
                prco("都说了没有红包了")
        ...
        if Number_of_transactions >= 50 and pref == False:
            prco("获得成就[" + Fore.LIGHTYELLOW_EX + "新年买东西居然不降价？" + Fore.RESET + "]")
            pref = True
            t.sleep(1)

        if pogo == False and Gold >= 50:
            prco("获得成就[" + Fore.LIGHTYELLOW_EX + "恭喜发财" + Fore.RESET + "]")
            pogo = True
            t.sleep(1)
        ...
        if golu == False and Number_of_not_bullied >= 10:
            prco("获得成就[" + Fore.LIGHTMAGENTA_EX + "来自财神的祝福" + Fore.RESET + "]")
            golu = True
            t.sleep(1)
        ...
        if ripe == False and Gold >= 500:
            prco("获得成就[" + Fore.LIGHTMAGENTA_EX + "给点红包吧awa" + Fore.RESET + "]")
            ripe = True
            t.sleep(1)
        ...
        if What_to_do == "1":
            ...
            # 普通
            if neco:
                prco("[" + Fore.LIGHTRED_EX + "新年快乐!" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if frsc:
                prco("[" + Fore.LIGHTGREEN_EX + "白手起家" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if figo:
                prco("[" + Fore.LIGHTGREEN_EX + "祝你财源滚滚" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if deal:
                prco("[" + Fore.LIGHTGREEN_EX + "成交！" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if coon:
                prco("[" + Fore.LIGHTGREEN_EX + "撸起袖子加油吃" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if cnsc:
                prco("[" + Fore.LIGHTGREEN_EX + "看,看不清楚" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")
            # 高级
            if aoag:
                prco("[" + Fore.LIGHTYELLOW_EX + "我会玩了" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if cost:
                prco("[" + Fore.LIGHTYELLOW_EX + "什么都是有代价的" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if stol:
                prco("[" + Fore.LIGHTYELLOW_EX + "黑吃黑？" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if prof:
                prco("[" + Fore.LIGHTYELLOW_EX + "专业小偷" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if pope:
                prco("[" + Fore.LIGHTYELLOW_EX + "没有红包哦" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if pogo:
                prco("[" + Fore.LIGHTYELLOW_EX + "恭喜发财" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if pref:
                prco("[" + Fore.LIGHTYELLOW_EX + "新年买东西居然不降价？" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")
            # 挑战
            if moex:
                prco("[" + Fore.LIGHTMAGENTA_EX + "小偷院长" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if golu:
                prco("[" + Fore.LIGHTMAGENTA_EX + "来自财神的祝福" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if balu:
                prco("[" + Fore.LIGHTMAGENTA_EX + "天生非酋体质" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if eate:
                prco("[" + Fore.LIGHTMAGENTA_EX + "黑吃黑,我是被吃的" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if mmod:
                prco("[" + Fore.LIGHTMAGENTA_EX + "真的是小偷！" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if ripe:
                prco("[" + Fore.LIGHTMAGENTA_EX + "给点红包吧awa" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")
        elif What_to_do == "6":
            prco(about)
