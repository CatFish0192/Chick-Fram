...
def prco(text, color=3):
    ...
    if color == 1:
        ...
        print(Fore.LIGHTMAGENTA_EX + text + Fore.RESET) #:
...
def logo():
    ...
    logo_width = 26 # logo的长度
    logo_height = 5 # logo的宽度
    
    line = 1
    
    logo_x = (width - logo_width) / 2 # 计算出logo的准确位置
    logo_y = (height - logo_height) / 2
    
    logo_x = int(logo_x) # 把不能整除的转换为整数
    logo_y = int(logo_y)
    ...
    for a in range(logo_y): # 上面的空行
        print()
    
    for c in range(logo_x): # 左边的空行
        print(" ", end="", flush=False)
    
    for b in range(1):
        for d in range(logo_height): #完善的一部分logo
            print(logo[str(line)])
            int(line)
            ...
            if line < logo_height: #继续下一部分logo
                line += 1
            else:
                break # 完成
     
    for a in range(logo_y):# 下面的空行
        print()
...
╰─────────────────────────╯
    ...
    # ↓死循环
    while True:
        if frsc == False and How_much_feed_the_chicks_ate_in_total > 10:
        ...
        if Whether_or_not_to_steal_it == "T" and How_much_feed_the_chicks_ate_in_total >= 20:
            ...
            if stol == False:
                prco("获得成就[" + Fore.LIGHTGREEN_EX + "黑吃黑？" + Fore.RESET + "]")
                stol = True
                t.sleep(1)
        ...
        if What_to_do == "1":
            ...
            if Whether_to_use_an_accelerator_card == "2" and Whether_to_use_stealth_potions == "2":
                ...
                if Whether_to_be_beaten_or_not == "F":
                    ...
                    if plead == "F":
                        ...
                        prco("饲料-10", 1)
                    if cost == False:
                        prco("获得成就[" + Fore.LIGHTGREEN_EX + "什么都是有代价的" + Fore.RESET + "]")
                        cost = True
            ...
            # 普通
            if neco:
                prco("[" + Fore.LIGHTGREEN_EX + "初来乍到" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")
            ...
            if figo:
                prco("[" + Fore.LIGHTGREEN_EX + "第一桶金" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")
            ...
            if stol:
                prco("[" + Fore.LIGHTGREEN_EX + "黑吃黑？" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if cost:
                prco("[" + Fore.LIGHTGREEN_EX + "什么都是有代价的" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")
            # 高级
            if aoag:
            ...
            if pope:
                prco("[" + Fore.LIGHTYELLOW_EX + "礼貌问候" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if pogo:
                prco("[" + Fore.LIGHTYELLOW_EX + "真的是一桶金" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if pref:
                prco("[" + Fore.LIGHTYELLOW_EX + "老顾客,有优惠吗?" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")
            # 挑战
            if moex:
            ...
            if golu:
                prco("[" + Fore.LIGHTMAGENTA_EX + "欧皇圣体" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")
            ...
            if ripe:
                prco("[" + Fore.LIGHTMAGENTA_EX + "大富翁" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")
#    eate = False #[黑吃黑,我是被吃的]
#    mmod = False #[真的是小偷！]
