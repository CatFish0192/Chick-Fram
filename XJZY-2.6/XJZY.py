...
def prco(text, color=3): #颜色模块
    ...
    if color == 1:
        ...
        print(Fore.LIGHTWHITE_EX + text + Fore.RESET) #white:普通
    elif color == 4:
...
╰─────────────────────────╯
    ...
    Data_Logging_one = ""
    Data_Logging_two = ""
    username = o.getlogin()+"\\XJZY.txt"
    userpath = o.path.join("C:\\Users\\",username)
    if not o.path.exists("XJZY.db"):
        txt_Gold = 5
        txt_Stealth_potions = 0
        txt_How_much_feed_the_chicks_ate_in_total = 10
        txt_Accelerator_card = 0
        txt_How_much_corn_is_there_in_total = 0
        txt_How_many_corn_seeds_there_were = 0
        with open(userpath, "w+", encoding="gbk") as number:  
            number.write(str(txt_Gold))
            number.write(",")
            number.write(str(txt_Stealth_potions))
            number.write(",")
            number.write(str(txt_How_much_feed_the_chicks_ate_in_total))
            number.write(",")
            number.write(str(txt_Accelerator_card))
            number.write(",")
            number.write(str(txt_How_much_corn_is_there_in_total))
            number.write(",")
            number.write(str(txt_How_many_corn_seeds_there_were))
        #初始化
        ...
        if o.path.exists(userpath):
            with open(userpath, "r", encoding="gbk") as number:
                Data_Logging_one = number.readline()
                Data_Logging_two = e.split(",", Data_Logging_one)
                txt_Gold = Data_Logging_two[0]
                txt_Stealth_potions = Data_Logging_two[1]
                txt_How_much_feed_the_chicks_ate_in_total = Data_Logging_two[2]
                txt_Accelerator_card = Data_Logging_two[3]
                txt_How_much_corn_is_there_in_total = Data_Logging_two[4]
                txt_How_many_corn_seeds_there_were = Data_Logging_two[5]

                txt_Gold = float(txt_Gold)
                txt_Stealth_potions = int(txt_Stealth_potions)
                txt_How_much_feed_the_chicks_ate_in_total = int(
                    txt_How_much_feed_the_chicks_ate_in_total
                )
                txt_Accelerator_card = int(txt_Accelerator_card)
                txt_How_much_corn_is_there_in_total = int(txt_How_much_corn_is_there_in_total)
                txt_How_many_corn_seeds_there_were = int(txt_How_many_corn_seeds_there_were)
        else:
            Gold = xjzydbresult[1]
            ...
            with open(userpath, "a"):
                txt_Gold = Gold
                txt_Stealth_potions = Stealth_potions
                txt_How_much_feed_the_chicks_ate_in_total = How_much_feed_the_chicks_ate_in_total
                txt_Accelerator_card = Accelerator_card
                txt_How_much_corn_is_there_in_total = How_much_corn_is_there_in_total
                txt_How_many_corn_seeds_there_were = How_many_corn_seeds_there_were
        if xjzydbresult != None: #数据库为空
            ...
            How_much_corn_is_there_in_total = xjzydbresult[5]
            How_many_corn_seeds_there_were = xjzydbresult[6]
            if txt_Gold != Gold or txt_Stealth_potions != Stealth_potions or txt_How_much_feed_the_chicks_ate_in_total != How_much_feed_the_chicks_ate_in_total or txt_Accelerator_card != Accelerator_card or txt_How_much_corn_is_there_in_total != How_much_corn_is_there_in_total or txt_How_many_corn_seeds_there_were != How_many_corn_seeds_there_were:
                Gold = txt_Gold
                Stealth_potions = txt_Stealth_potions
                How_much_feed_the_chicks_ate_in_total = txt_How_much_feed_the_chicks_ate_in_total
                Accelerator_card = txt_Accelerator_card
                How_much_corn_is_there_in_total = txt_How_much_corn_is_there_in_total
                How_many_corn_seeds_there_were = txt_How_many_corn_seeds_there_were
    ...
    while True:
        ...
        if What_to_do == "1":
            if Accelerator_card > 0:
                ...
                prco("2、不要", 2)
                t.sleep(0.5)
                Whether_to_use_an_accelerator_card = input(Fore.BLUE + "你要用加速卡吗？")
            else:
            ...
            if Stealth_potions > 0:
                ...
                prco("2、不要", 2)
                t.sleep(0.5)
                Whether_to_use_stealth_potions = input(Fore.BLUE + "你要用隐身药剂吗？")
            else:
            ...
            if How_many_corn_seeds_there_were == 0:
                ...
                try:
                    How_much_to_plant = int(input(Fore.BLUE + "你要种多少玉米？"))
                except ValueError:
                    prco("额，看来你不想种玉米", 1)
                # ↓没有发生错误时执行else语句
                else:
            ...
            if Why == "1":
                ...
                try:
                    ...
                    if How_much_feed_to_buy != 0: #此处有一个远古BUG（已修复）
                ...
                try:
                    ...
                    if (How_much_stealth_potion_to_buy * 15) > Gold:
                        prco("你的金币还不够哦！", 1)
