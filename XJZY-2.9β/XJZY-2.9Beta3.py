...
https://gitcode.com/bxl24563/XJZY
    ...
    while True:
        ...
        elif neco and frsc and figo and deal and coon and cnsc and stol and cost and aoag == False:
            prco("获得成就[" + Fore.LIGHTYELLOW_EX + "我会玩了" + Fore.RESET + "]")
            aoag = True
            t.sleep(1)

        elif Number_of_thefts >= 50 and prof == False:
            prco("获得成就[" + Fore.LIGHTYELLOW_EX + "专业小偷" + Fore.RESET + "]")
            prof = True
            t.sleep(1)

        elif Number_of_transactions >= 50 and pref == False:
            prco("获得成就[" + Fore.LIGHTYELLOW_EX + "老顾客,有优惠吗?" + Fore.RESET + "]")
            pref = True
            t.sleep(1)

        elif pogo == False and Gold >= 50:
            prco("获得成就[" + Fore.LIGHTYELLOW_EX + "真的是一桶金" + Fore.RESET + "]")
            pogo = True
            t.sleep(1)

        elif Number_of_thefts >= 100 and moex == False:
            prco("获得成就[" + Fore.LIGHTMAGENTA_EX + "小偷院长" + Fore.RESET + "]")
            moex = True
            t.sleep(1)

        elif golu == False and Number_of_not_bullied >= 10:
            prco("获得成就[" + Fore.LIGHTMAGENTA_EX + "欧皇圣体" + Fore.RESET + "]")
            golu = True
            t.sleep(1)

        elif balu == False and Number_of_been_bullied >= 10:
            prco("获得成就[" + Fore.LIGHTMAGENTA_EX + "天生非酋体质" + Fore.RESET + "]")
            balu = True
            t.sleep(1)

        elif ripe == False and Gold >= 500:
