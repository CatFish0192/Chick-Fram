...
╰─────────────────────────╯
    ...
    while True:
        ...
        if ripe == False and Gold >= 100:
            prco("获得成就[" + Fore.LIGHTGREEN_EX + "大富翁" + Fore.RESET + "]")
            ripe = True
            t.sleep(1)
        ...
        if What_to_do == "1":
            ...
            # 挑战
            if mmod:
                prco("[" + Fore.LIGHTGREEN_EX + "真的是小偷！" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if pope:
                prco("[" + Fore.LIGHTGREEN_EX + "礼貌问候" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")

            if ripe:
                prco("[" + Fore.LIGHTGREEN_EX + "大富翁" + Fore.LIGHTWHITE_EX + "]" + Fore.RESET)
            else:
                prco("[????????]")
#                # 普通
#    neco = False #初来乍到
